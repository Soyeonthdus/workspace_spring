...
<table align="center" width="650px" height="280px">
	...
	<tr>
		...
		<td width="580px">
			<input id="bm_writer" value="작성자" name="bm_writer" class="easyui-textbox">
		</td>
	</tr>	
	<tr>
		<td width="120px">내용</td>
		<td width="580px">
			<input id="bm_content" multiline="true" value="내용" name="bm_content" class="easyui-textbox" style="width:100%;height:100px">
		</td>
	</tr>	
	<tr>
